...
namespace TuyenGameCore.Slicer2D
{
                    ...
                    if (cutEnter.rigidbody == cutExit.rigidbody)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    CapsuleCollider2D CapsuleCollider = parentRigidBody.GetComponent<CapsuleCollider2D>();
                                    if (CapsuleCollider)
                                    {
                                        polygonPoints = new List<Vector2>(4);

                                        Vector2 colliderCenter = CapsuleCollider.offset;

                                        polygonPoints.Add(colliderCenter + new Vector2(-CapsuleCollider.size.x * 0.5f, -CapsuleCollider.size.y * 0.5f));
                                        polygonPoints.Add(colliderCenter + new Vector2(CapsuleCollider.size.x * 0.5f, -CapsuleCollider.size.y * 0.5f));
                                        polygonPoints.Add(colliderCenter + new Vector2(CapsuleCollider.size.x * 0.5f, CapsuleCollider.size.y * 0.5f));
                                        polygonPoints.Add(colliderCenter + new Vector2(-CapsuleCollider.size.x * 0.5f, CapsuleCollider.size.y * 0.5f));
