...
{
    internal class FrameTimeIntervalObservable<T> : OperatorObservableBase<EranCore.UniRx.TimeInterval<T>>
    {
        ...
        class FrameTimeInterval : OperatorObserverBase<T, EranCore.UniRx.TimeInterval<T>>
        {
            readonly FrameTimeIntervalObservable<T> parent;
            float lastTime;

            public FrameTimeInterval(FrameTimeIntervalObservable<T> parent, IObserver<EranCore.UniRx.TimeInterval<T>> observer, IDisposable cancel)
            ...
            public override void OnNext(T value)
            {
                ...
                base.observer.OnNext(new EranCore.UniRx.TimeInterval<T>(value, TimeSpan.FromSeconds(span)));
            }
