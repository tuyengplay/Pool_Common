...
namespace EranCore.UniRx
{
    ...
    {
        EranCore.UniRx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>> asyncActions = EranCore.UniRx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>>.Empty;
        ...
        public void Dispose()
        {
            ...
            IsDisposed = true;
            asyncActions = EranCore.UniRx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>>.Empty;
        }
