...
using EranCore.UniRx.Triggers;
using UnityEngine;
using System.Threading;

#if !UniRxLibrary
using SchedulerUnity = EranCore.UniRx.Scheduler;
#endif
...
#pragma warning restore CS0618
        ...
        {
            return new EranCore.UniRx.Operators.FromCoroutineObservable<T>(coroutine);
        }
        ...
        {
            return new EranCore.UniRx.Operators.FromMicroCoroutineObservable<T>(coroutine, frameCountType);
        }
        ...
        public static IObservable<T> DelayFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType = FrameCountType.Update)
        {
            ...
            return new EranCore.UniRx.Operators.DelayFrameObservable<T>(source, frameCount, frameCountType);
        }

        public static IObservable<T> Sample<T, T2>(this IObservable<T> source, IObservable<T2> sampler)
        {
            return new EranCore.UniRx.Operators.SampleObservable<T, T2>(source, sampler);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new EranCore.UniRx.Operators.SampleFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new EranCore.UniRx.Operators.ThrottleFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new EranCore.UniRx.Operators.ThrottleFirstFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new EranCore.UniRx.Operators.TimeoutFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new EranCore.UniRx.Operators.DelayFrameSubscriptionObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            return new EranCore.UniRx.Operators.RepeatUntilObservable<T>(sources, trigger, lifeTimeChecker);
        }

        public static IObservable<EranCore.UniRx.FrameInterval<T>> FrameInterval<T>(this IObservable<T> source)
        {
            return new EranCore.UniRx.Operators.FrameIntervalObservable<T>(source);
        }

        public static IObservable<EranCore.UniRx.TimeInterval<T>> FrameTimeInterval<T>(this IObservable<T> source, bool ignoreTimeScale = false)
        {
            return new EranCore.UniRx.Operators.FrameTimeIntervalObservable<T>(source, ignoreTimeScale);
        }
        ...
        public static IObservable<IList<T>> BatchFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType)
        {
            ...
            return new EranCore.UniRx.Operators.BatchFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentException("frameCount must be >= 0, frameCount:" + frameCount);
            return new EranCore.UniRx.Operators.BatchFrameObservable(source, frameCount, frameCountType);
        }
