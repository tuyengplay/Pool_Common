...
namespace EranCore.UniRx
{
    public static class Observer
    {
        ...
        {
            return Create<T>(onNext, EranCore.UniRx.Stubs.Throw, EranCore.UniRx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action<Exception> onError)
        {
            return Create<T>(onNext, onError, EranCore.UniRx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action onCompleted)
        {
            return Create<T>(onNext, EranCore.UniRx.Stubs.Throw, onCompleted);
        }
        ...
        class AutoDetachObserver<T> : EranCore.UniRx.Operators.OperatorObserverBase<T, T>
        {
    ...
    public static partial class ObserverExtensions
    {
        ...
        {
            return new EranCore.UniRx.Operators.SynchronizedObserver<T>(observer, new object());
        }

        public static IObserver<T> Synchronize<T>(this IObserver<T> observer, object gate)
        {
            return new EranCore.UniRx.Operators.SynchronizedObserver<T>(observer, gate);
        }
    }
    ...
    public static partial class ObservableExtensions
    {
        ...
        {
            return source.Subscribe(EranCore.UniRx.InternalUtil.ThrowObserver<T>.Instance);
        }
