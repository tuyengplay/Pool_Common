...
using EranCore.UniRx.Operators;
...
namespace EranCore.UniRx
{
    ...
    public static partial class Observable
    {
        ...
        public static IObservable<EranCore.UniRx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source)
        {
            return TimeInterval(source, Scheduler.DefaultSchedulers.TimeBasedOperations);
        }

        public static IObservable<EranCore.UniRx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source, IScheduler scheduler)
        {
            return new EranCore.UniRx.Operators.TimeIntervalObservable<TSource>(source, scheduler);
        }
